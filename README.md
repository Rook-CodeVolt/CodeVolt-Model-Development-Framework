...
See [Architecture](docs/ARCHITECTURE.md), [Roadmap](docs/ROADMAP.md), [Agent integration](docs/AGENT_INTEGRATION.md), and [Contributing](CONTRIBUTING.md) for the full design and ways to participate.
